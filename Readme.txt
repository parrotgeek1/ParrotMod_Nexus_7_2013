...
Download: [url]https://github.com/parrotgeek1/ParrotModFloApp/blob/master/app/app-release.apk?raw=true[/url]

GitHub: [url]https://github.com/parrotgeek1/ParrotModFloApp[/url]
...
If ParrotMod does not improve the touchscreen at all, it could be that the touchscreen cable is loose inside the tablet. There are YouTube videos on how to fix this, like this popular one: [url]https://www.youtube.com/watch?v=cOnccu6Nbl0[/url]

The feature fixing the auto rotate bug might not work for everyone. If it doesn't, here is a real hardware fix: [url]https://www.youtube.com/watch?v=LLCAeBe2hVU[/url]
